...
L_8001D31C:
    ...
    ctx->r2 = S32(0X8002 << 16);
    // addiu       $fp, $v0, -0x2D9C
    ctx->r30 = ADD32(ctx->r2, -0X2D9C);
L_8001D32C:
    // lw          $a3, 0x228($sp)
    ctx->r7 = MEM_W(0X228, ctx->r29);
    // addiu       $v0, $zero, -0x1
    ctx->r2 = ADD32(0, -0X1);
    // addiu       $a3, $a3, -0x1
    ctx->r7 = ADD32(ctx->r7, -0X1);
    // beq         $a3, $v0, L_8001DAAC
    if (ctx->r7 == ctx->r2) {
        // sw          $a3, 0x228($sp)
...
L_8001D3D0:
    ...
    ctx->r3 = ADD32(ctx->r3, ctx->r2);
    // sw          $v0, 0x1E4($s1)
    MEM_W(0X1E4, ctx->r17) = ctx->r2;
    // lw          $v0, 0x3C4($s1)
    ctx->r2 = MEM_W(0X3C4, ctx->r17);
    // sll         $v1, $v1, 2
    ctx->r3 = S32(ctx->r3) << 2;
    // addu        $v0, $v0, $v1
    ctx->r2 = ADD32(ctx->r2, ctx->r3);
    ...
    // lhu         $s7, 0x18($a0)
    ctx->r23 = MEM_HU(0X18, ctx->r4);
    // lw          $a0, 0xC($s1)
    ctx->r4 = MEM_W(0XC, ctx->r17);
    // lw          $v1, 0x1B4($s1)
    ctx->r3 = MEM_W(0X1B4, ctx->r17);
    // addiu       $v0, $v0, 0xC
    ctx->r2 = ADD32(ctx->r2, 0XC);
    // addu        $s4, $a0, $v0
    ctx->r20 = ADD32(ctx->r4, ctx->r2);
    // addu        $v1, $v1, $s7
    ...
    // beq         $v0, $zero, L_8001DA7C
    if (ctx->r2 == 0) {
        // sw          $v1, 0x1B4($s1)
        MEM_W(0X1B4, ctx->r17) = ctx->r3;
        goto L_8001DA7C;
    }
    // sw          $v1, 0x1B4($s1)
    MEM_W(0X1B4, ctx->r17) = ctx->r3;
...
L_8001D55C:
    ...
    // lw          $v0, 0x84($s1)
    ctx->r2 = MEM_W(0X84, ctx->r17);
    // nop

    // slt         $v0, $v0, $v1
    ctx->r2 = SIGNED(ctx->r2) < SIGNED(ctx->r3) ? 1 : 0;
    // beq         $v0, $zero, L_8001D57C
    if (ctx->r2 == 0) {
        // nop
...
L_8001D594:
    ...
    // beq         $v0, $zero, L_8001DA68
    if (ctx->r2 == 0) {
        // sw          $v1, 0x88($s1)
        MEM_W(0X88, ctx->r17) = ctx->r3;
        goto L_8001DA68;
    }
    // sw          $v1, 0x88($s1)
    MEM_W(0X88, ctx->r17) = ctx->r3;
    // lw          $v0, 0x8C($s1)
    ctx->r2 = MEM_W(0X8C, ctx->r17);
    // nop
...
L_8001D724:
    ...
    gte_ctc2(ctx, 14, 7);
    // lwl         $v0, 0x47($s1)
    ctx->r2 = do_lwl(rdram, ctx->r2, 0X47, ctx->r17);
    // lwr         $v0, 0x44($s1)
    ctx->r2 = do_lwr(rdram, ctx->r2, 0X44, ctx->r17);
    // nop
...
L_8001DA88:
    ...
    // bne         $t0, $v0, L_8001D358
    if (ctx->r8 != ctx->r2) {
        // sw          $t0, 0x228($sp)
        MEM_W(0X228, ctx->r29) = ctx->r8;
        goto L_8001D358;
    }
    // sw          $t0, 0x228($sp)
    MEM_W(0X228, ctx->r29) = ctx->r8;
