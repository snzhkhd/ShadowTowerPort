...
L_80075FFC:
    ...
    ctx->r25 = S32(U32(ctx->r25) >> 1);
    // sb          $t7, 0xC($a3)
    MEM_B(0XC, ctx->r7) = ctx->r15;
    // sb          $t8, 0x24($a3)
    MEM_B(0X24, ctx->r7) = ctx->r24;
    // sb          $t9, 0x3C($a3)
    MEM_B(0X3C, ctx->r7) = ctx->r25;
    // lbu         $t4, 0xD($t0)
    ...
    ctx->r25 = S32(U32(ctx->r25) >> 1);
    // sb          $t7, 0xD($a3)
    MEM_B(0XD, ctx->r7) = ctx->r15;
    // sb          $t8, 0x25($a3)
    MEM_B(0X25, ctx->r7) = ctx->r24;
    // sb          $t9, 0x3D($a3)
    MEM_B(0X3D, ctx->r7) = ctx->r25;
    // lbu         $t4, 0xE($t0)
    ...
    ctx->r25 = S32(U32(ctx->r25) >> 1);
    // sb          $t7, 0xE($a3)
    MEM_B(0XE, ctx->r7) = ctx->r15;
    // sb          $t8, 0x26($a3)
    MEM_B(0X26, ctx->r7) = ctx->r24;
    // sb          $t9, 0x3E($a3)
    MEM_B(0X3E, ctx->r7) = ctx->r25;
    // lw          $t4, 0x0($a1)
    ctx->r12 = MEM_W(0X0, ctx->r5);
    // addiu       $a2, $a2, 0x1
    ctx->r6 = ADD32(ctx->r6, 0X1);
    // bne         $t4, $a2, L_80076218
    if (ctx->r12 != ctx->r6) {
        // nop
