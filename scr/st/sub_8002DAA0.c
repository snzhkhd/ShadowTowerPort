...
L_8002DBD8:
    ...
    // beq         $v0, $zero, L_8002DBF4
    if (ctx->r2 == 0) {
        // addiu       $s3, $s2, 0x300
        ctx->r19 = ADD32(ctx->r18, 0X300);
        goto L_8002DBF4;
    }
    // addiu       $s3, $s2, 0x300
    ctx->r19 = ADD32(ctx->r18, 0X300);
    // j           L_8002DBFC
    // addiu       $s4, $s2, 0x310
    ctx->r20 = ADD32(ctx->r18, 0X310);
    goto L_8002DBFC;
    // addiu       $s4, $s2, 0x310
    ctx->r20 = ADD32(ctx->r18, 0X310);
L_8002DBF4:
    // addiu       $s3, $s2, 0x30C
    ctx->r19 = ADD32(ctx->r18, 0X30C);
    // addiu       $s4, $s2, 0x31C
    ctx->r20 = ADD32(ctx->r18, 0X31C);
L_8002DBFC:
    // addiu       $a1, $zero, 0x1C
    ctx->r5 = ADD32(0, 0X1C);
    // andi        $a2, $fp, 0xFFFF
