...
L_800769F4:
    ...
    // lbu         $t4, 0xC($t0)
    ctx->r12 = MEM_BU(0XC, ctx->r8);
    // .word       0x4A280030                   # INVALID     $s1, $t0, 0x30 # 00000000 <InstrIdType: CPU_COP2>
    gte_command(ctx, 0x4A280030);
    // lbu         $t5, 0xC($t1)
    ctx->r13 = MEM_BU(0XC, ctx->r9);
    // lbu         $t6, 0xC($t2)
    ctx->r14 = MEM_BU(0XC, ctx->r10);
    // lbu         $t7, 0xC($t3)
    ctx->r15 = MEM_BU(0XC, ctx->r11);
    // add         $t9, $t4, $t6
    ctx->r25 = ADD32(ctx->r12, ctx->r14);
    // add         $t8, $t7, $t5
    ctx->r24 = ADD32(ctx->r15, ctx->r13);
    ...
    ctx->r25 = S32(ctx->r25) >> 1;
    // sb          $t8, 0x3C($a3)
    MEM_B(0X3C, ctx->r7) = ctx->r24;
    // sb          $t9, 0x24($a3)
    MEM_B(0X24, ctx->r7) = ctx->r25;
    // add         $t8, $t4, $t5
    ctx->r24 = ADD32(ctx->r12, ctx->r13);
    // add         $t9, $t7, $t6
    ctx->r25 = ADD32(ctx->r15, ctx->r14);
    ...
    // sb          $t9, 0x54($a3)
    MEM_B(0X54, ctx->r7) = ctx->r25;
    // sb          $v1, 0x6C($a3)
    MEM_B(0X6C, ctx->r7) = ctx->r3;
    // lbu         $t4, 0xD($t0)
    ctx->r12 = MEM_BU(0XD, ctx->r8);
    // lbu         $t5, 0xD($t1)
    ctx->r13 = MEM_BU(0XD, ctx->r9);
    // lbu         $t6, 0xD($t2)
    ctx->r14 = MEM_BU(0XD, ctx->r10);
    // lbu         $t7, 0xD($t3)
    ctx->r15 = MEM_BU(0XD, ctx->r11);
    // add         $t9, $t4, $t6
    ctx->r25 = ADD32(ctx->r12, ctx->r14);
    // add         $t8, $t7, $t5
    ctx->r24 = ADD32(ctx->r15, ctx->r13);
    ...
    ctx->r25 = S32(ctx->r25) >> 1;
    // sb          $t8, 0x3D($a3)
    MEM_B(0X3D, ctx->r7) = ctx->r24;
    // sb          $t9, 0x25($a3)
    MEM_B(0X25, ctx->r7) = ctx->r25;
    // add         $t8, $t4, $t5
    ctx->r24 = ADD32(ctx->r12, ctx->r13);
    // add         $t9, $t7, $t6
    ctx->r25 = ADD32(ctx->r15, ctx->r14);
    ...
    ctx->r3 = S32(ctx->r3) >> 2;
    // sb          $t8, 0xD($a3)
    MEM_B(0XD, ctx->r7) = ctx->r24;
    // sb          $t9, 0x55($a3)
    MEM_B(0X55, ctx->r7) = ctx->r25;
    // sb          $v1, 0x6D($a3)
    MEM_B(0X6D, ctx->r7) = ctx->r3;
    // lbu         $t4, 0xE($t0)
    ctx->r12 = MEM_BU(0XE, ctx->r8);
    // lbu         $t5, 0xE($t1)
    ctx->r13 = MEM_BU(0XE, ctx->r9);
    // lbu         $t6, 0xE($t2)
    ctx->r14 = MEM_BU(0XE, ctx->r10);
    // lbu         $t7, 0xE($t3)
    ctx->r15 = MEM_BU(0XE, ctx->r11);
    // add         $t9, $t4, $t6
    ctx->r25 = ADD32(ctx->r12, ctx->r14);
    // add         $t8, $t7, $t5
    ctx->r24 = ADD32(ctx->r15, ctx->r13);
    ...
    ctx->r25 = S32(ctx->r25) >> 1;
    // sb          $t8, 0x3E($a3)
    MEM_B(0X3E, ctx->r7) = ctx->r24;
    // sb          $t9, 0x26($a3)
    MEM_B(0X26, ctx->r7) = ctx->r25;
    // add         $t8, $t4, $t5
    ctx->r24 = ADD32(ctx->r12, ctx->r13);
    // add         $t9, $t7, $t6
    ctx->r25 = ADD32(ctx->r15, ctx->r14);
    ...
    ctx->r3 = S32(ctx->r3) >> 2;
    // sb          $t8, 0xE($a3)
    MEM_B(0XE, ctx->r7) = ctx->r24;
    // sb          $t9, 0x56($a3)
    MEM_B(0X56, ctx->r7) = ctx->r25;
    // sb          $v1, 0x6E($a3)
    MEM_B(0X6E, ctx->r7) = ctx->r3;
    // swc2        $12, 0x40($a3)
    gte_swc2(rdram, ctx, 12, 7, 64);
    // swc2        $13, 0x58($a3)
    gte_swc2(rdram, ctx, 13, 7, 88);
    // swc2        $17, 0x44($a3)
    gte_swc2(rdram, ctx, 17, 7, 68);
    // swc2        $18, 0x5C($a3)
    gte_swc2(rdram, ctx, 18, 7, 92);
    // lw          $t4, 0x0($a1)
    ctx->r12 = MEM_W(0X0, ctx->r5);
    // addiu       $a2, $a2, 0x1
    ctx->r6 = ADD32(ctx->r6, 0X1);
    // bne         $t4, $a2, L_80076D30
    if (ctx->r12 != ctx->r6) {
        // nop
