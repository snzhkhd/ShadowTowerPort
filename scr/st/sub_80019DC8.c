...
L_80019F3C:
    ...
    // lhu         $a0, 0x18($v0)
    ctx->r4 = MEM_HU(0X18, ctx->r2);
    // jal         0x800194C4
    // addu        $a3, $s1, $zero
    ctx->r7 = ADD32(ctx->r17, 0);
    sub_800194C4(rdram, ctx);
    goto after_0;
    // addu        $a3, $s1, $zero
    ctx->r7 = ADD32(ctx->r17, 0);
    after_0:
